...
<%@taglib prefix="myTagLib" uri="http://epam.by/myTag" %>
>
...
<jsp:useBean id="user" scope="request" type="by.epam.servletCourse.bean.User"></jsp:useBean>
<%--	<section>--%>
...
<myTagLib:formatDate date="<%=Calendar.getInstance().getTime()%>" format="dd-MM-yyyy"/>
	...
	<div class="container">
		...
		<table id="profile">
			...
			<tr>
				...
				<%--					<td>${user.activity}</td>--%>
				<td>
					<jsp:getProperty name="user" property="activity"/>
				</td>
			</tr>
